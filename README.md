...
class Order < ActiveRecord::Base
  ...
  # typed_class replaces T.bind(self, T.class_of(ApplicationRecord))
  typed_class.validates :status, presence: true
  typed_class.enum :status, { draft: 0, published: 1 }

  def active?
    # typed_instance replaces T.cast(self, ApplicationRecord)
